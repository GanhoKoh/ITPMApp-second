package com.example.itpmapp_second.databases;
...
public class ITPMDatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public ITPMDatabaseOpenHelper(@NonNull  Context context) {
